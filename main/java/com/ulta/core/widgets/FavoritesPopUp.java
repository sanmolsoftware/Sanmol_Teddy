...
/**
 * The Class OptionsPopUp.
 */
public class FavoritesPopUp extends PopupWindow implements OnTouchListener {
...
/*	private ImageView imgViewType;*/
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case 4:
		case 5:
//			showRating(idClicked);
//			currentRating = idClicked;
			break;
		}
		return false;
	}
	...
	/*	imgViewType = (ImageView) rootView.findViewById(R.id.imgViewType);
		tvViewType=(TextView)rootView.findViewById(R.id.tvViewType);*/
		
		
		llViewType = (LinearLayout) rootView.findViewById(R.id.llViewType);
		llViewType.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				onOptionsClickedListener.onOptionsClicked(1);
			}
		});
		...
		llSort.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				onOptionsClickedListener.onOptionsClicked(2);
			}
		});
		...
		llFilter.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				onOptionsClickedListener.onOptionsClicked(3);
			}
		});
